...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-3xl mx-auto py-8 space-y-4">
        <p><strong>Task:</strong> <?php echo e($assignment->task->title); ?></p>
        <p><strong>Description:</strong> <?php echo e($assignment->task->description); ?></p>
        <p><strong>Budget:</strong> $<?php echo e($assignment->task->budget); ?></p>
        <p><strong>Assigned By:</strong> <?php echo e($assignment->employer->name); ?></p>
        <p><strong>Started At:</strong> <?php echo e($assignment->started_at->format('Y-m-d')); ?></p>
...
<?php endif; ?>
<?php /**PATH /Users/baikuili/Sites/job-platform/resources/views/assignments/show.blade.php ENDPATH**/ ?>